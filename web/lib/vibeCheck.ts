// web/lib/vibeCheck.ts
// Small display helpers shared by every surface that renders Vibe Check data
// (trading card, own profile, matched-dog profile, swipe card detail).
 ...
 *  description). Never claim what a specific letter means; only name the
 *  four axes it spans. */
